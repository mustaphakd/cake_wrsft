...
<div class="payment-online-form-left">
    <?php
    echo $this->Form->create(null, array("admin" => true, "controller" => "products", "action" => "edit", "url" => array("controller" => "products")));
    echo '<fieldset>';
    echo    '<legend>Product Edit Form</legend>'
        . '<div class="row">'
        .'<div class="col-lg-4">';
    ...
    echo $this->Form->end(array(
        ...
        "before" => '<ul class="payment-sendbtns list-unstyled"><li>'.
            '<a style="margin-top: 1em; padding-bottom: .75em;" href="' . $backlink .'"> Cancel</a>'
            .'<li>',"after" => '</li></ul><div class="clearfix"> </div>'
    ))
